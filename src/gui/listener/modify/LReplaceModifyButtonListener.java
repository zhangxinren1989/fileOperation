...
public class LReplaceModifyButtonListener implements ActionListener {
	private FReplacePanel parentComponent;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(extendNames == null || extendNames.isEmpty())
		{
		...
		OneLevelModify.replaceModify(file, replace, replaceAs, replaceIndex, extendNames, nonExtendNames); 
	...
	public LReplaceModifyButtonListener(FReplacePanel parentComponent)
	{
