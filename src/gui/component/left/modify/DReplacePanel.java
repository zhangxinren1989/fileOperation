...
import gui.listener.modify.DReplaceModifyButtonListener;

public class DReplacePanel extends JPanel {
	private static final long serialVersionUID = 598033739251476995L;
	...
	public DReplacePanel(JComponent parentComponent)
	{
		setBorder(BorderFactory.createTitledBorder("字符串替换改文件夹名"));
		//setSize(400, 200);
		add(replaceLabel);
		add(replaceField);
		add(tips);
		...
		add(tips2);
		add(modifyButton);
		modifyButton.addActionListener(new DReplaceModifyButtonListener(this));
